...
public class ModificationElementStock extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title> modification de l'element de stock</title>");   
            out.println("</head>");
            out.println("<body>");
             out.println("<form  action = \"ModificationElementStock\" method = \"POST\"> ");
            ...
            System.out.println("Probleme dans la servlet de modification de l'element");
    }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form  action = \"ModificationElementStock\" method = \"GET\"> ");
