...
public class CreationStock extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title> Creation de stock</title>");            
            out.println("</head>");
             out.println("<form  action = \"CreationStock\" method = \"POST\"> ");
            out.println("Nom du Stock:");
            out.println("<input type=\"text\" name=\"NameStock\" value =\"\" />");
            out.println("<br/>");            
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form  action = \"CreationStock\" method = \"GET\"> ");
            Boolean ret = stockFacade.creerStock(request.getParameter("NameStock"));
             if(ret==true)
            {
                out.println("Stock créé avec succes <br/>");
            }
            else
            {
                out.println("Impossible de creer le stock <br/>");
            }
            out.println("<input type=\"submit\" value =\"Créer\" />");
            out.println("</form>");  
