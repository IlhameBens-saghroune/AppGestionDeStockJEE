...
public class SuppressionMarque extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form  action = \"SuppressionMarque\" method = \"POST\"> ");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<form  action = \"SuppressionMarque\" method = \"GET\"> ");
            
            Boolean ret=marqueFacade.supprimerMarque(request.getParameter("NameM"));
            if(ret==true)
            {
                out.println("Marque supprimer avec succes <br/>");
            }
            else
            {
                out.println("Le nom de la marque n'existe pas. Impossible de supprimer la marque <br/>");
            }
