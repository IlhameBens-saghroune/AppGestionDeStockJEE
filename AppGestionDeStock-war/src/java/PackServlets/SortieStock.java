...
public class SortieStock extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SortieStock at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("</head>");
            out.println("<body>");
             out.println("<form  action = \"SortieStock\" method = \"POST\"> ");
            ...
            System.out.println("Probleme dans la servlet de sortie");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            out.println("</head>");
            out.println("<body>"); 
            out.println("<form  action = \"SortieStock\" method = \"GET\"> ");
            Boolean ret=stockFacade.SortieStock(request.getParameter("NomStock"), request.getParameter("RefProduit"), Integer.parseInt(request.getParameter("Quantite")));

            if(ret==true)
            {
                out.println("Sortie du stock valide <br/>");
               
            }
            else
            {
                out.println("Sortie du stock non valide <br/>");
            }
