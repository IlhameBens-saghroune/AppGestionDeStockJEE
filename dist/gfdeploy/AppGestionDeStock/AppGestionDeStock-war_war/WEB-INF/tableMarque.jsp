<%-- 
    Document   : tableMarque
    Created on : Jun 20, 2022, 3:26:31 AM
    Author     : ILHAM
--%>
<%@page import="PackEntities.Marque"%>
<%@page import="PackEntities.MarqueFacadeLocal"%>
<%@page import="javax.ejb.EJB"%>
<%@page import="PackEntities.Produit"%>
                                ...
                                <div class="table-responsive">
                                    <table class="table " id="dataTable" width="100%" cellspacing="0" style="border: 1px solid rgba(0, 0, 0, 0.125); border-radius: 5px;">
                                        ...
                                        <tbody>
                                            ...
                                            %>
                                            <tr>
                                                <td style="border: 0.5px solid rgba(0, 0, 0, 0.125); "><%= LsProduits.get(i).getRefProduit() %></td>
                                                ...
                                                <td style="border: 0.5px solid rgba(0, 0, 0, 0.125); ">
                                                    <a href="/AppGestionDeStock-war/ModificationProduit?nom=<%= LsProduits.get(i).getRefProduit() %>
                                                    ...
                                                    <a href="/AppGestionDeStock-war/SuppressionProduit?nom=<%= LsProduits.get(i).getRefProduit() %>" >Supprimer </a></td>
                                            </tr>
                                            <%      }
